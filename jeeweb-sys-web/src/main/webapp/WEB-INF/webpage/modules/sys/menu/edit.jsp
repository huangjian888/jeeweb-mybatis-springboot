		   ...
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td class="width-35" >
				  ...
				  <td  class="width-15 active text-right">
					  <label><font color="red">*</font>菜单类型:</label>
				  </td>
				  <td class="width-35" >
					  <form:input path="type" class="form-control "  nullmsg="请输入菜单类型！" htmlEscape="false" datatype="*"/>
					  <span class="help-block m-b-none"><i class="fa fa-info-circle"></i>1:菜单 2：权限 3：开发</span>
					  <label class="Validform_checktip"></label>
				  </td>
		      </tr>
		       <tr>
