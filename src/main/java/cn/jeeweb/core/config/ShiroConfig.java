...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(@Qualifier("onlineSessionFactory") OnlineSessionFactory onlineSessionFactory,
                                         @Qualifier("sessionDAO") CacheSessionDAO sessionDAO,
    ...
    public CacheSessionDAO sessionDAO(@Qualifier("sessionIdGenerator") JavaUuidSessionIdGenerator sessionIdGenerator){
    ...
    public RetryLimitHashedCredentialsMatcher credentialsMatcher(@Qualifier("shiroCacheManager") SpringCacheManagerWrapper shiroCacheManager){
    ...
    @Bean
    public OnlineSessionFilter onlineSessionFilter(@Qualifier("sessionDAO") CacheSessionDAO sessionDAO){
